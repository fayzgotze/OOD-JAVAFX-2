...
public class ProductController {
    ...
    public List<Product> get() throws Exception {
        ...
        // TODO 06: HINT: a relevant call to a WarehouseDSC method. 
    ...
    public Product get(int id) throws Exception {
        ...
        // TODO 07: HINT: a relevant call to a WarehouseDSC method
    ...
    public List<Product> getAllExpiredItems() throws Exception {
        ...
        // TODO 08: HINT: a relevant call to a WarehouseDSC method
		return WarehouseDSC.getAllExpiredItems(id);
        //return null; // the completed method should not return null
    }
    public int add(Product g) throws Exception {
        ...
        // TODO 10: make a relevant call to a WarehouseDSC method
		int newId = WarehouseDSC.addProduct(g.getItemName(), g.getQuantity(), g.getSection());
    ...
    public Product update(int id) throws Exception {
        ...
        // TODO 11: make a relevant call to a WarehouseDSC method
    ...
    public int delete(int id) throws Exception {
        ...
        // TODO 12: make a relevant call to a WarehouseDSC method
        //return 0; // this method should return what ever the WarehouseDSC method call (TODO 12) returns
